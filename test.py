...
def main(flags):
    ...
    with tf.Session() as sess:
        ...
        try:
            ...
            constant_graph = graph_util.convert_variables_to_constants(sess, sess.graph_def, ["final/Sigmoid"])
            with tf.gfile.FastGFile('u-net.pb', mode='wb') as f:
